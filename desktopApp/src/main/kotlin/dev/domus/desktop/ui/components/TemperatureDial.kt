...
private val DIAL_SIZE = 300.dp
private val STROKE_WIDTH = 22.dp
    ...
    Box(
        ...
        Canvas(modifier = Modifier.size(DIAL_SIZE)) {
            ...
            if (current != null) {
                ...
                drawCircle(color = currentMarkerColor, radius = 7.dp.toPx(), center = markerPos)
            }
        ...
        if (current != null) {
            ...
            Text(
                ...
                modifier = Modifier
                    ...
                    .offset(x = labelX - 18.dp, y = labelY - 10.dp),
            )
        }
